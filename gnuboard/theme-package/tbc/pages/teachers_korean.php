                ...
                <div id="shSubBnr">
                    <div class="sub_nav">
                        <p class="crumb" data-aos="fade-up" data-aos-delay="300">
                            <a href="<?php echo G5_URL; ?>"><i data-feather="home"></i></a>강사진 <i data-feather="chevron-right"></i>국어</p>
                        <p class="tit" data-aos="fade-up" data-aos-delay="600">국어</p>
                    </div>
            ...
            <div id="sh_content">
                ...
                <div id="members1005">
                    <div class="inner">
                        ...
                        <?php $tbc_teacher_subject = 'korean'; include_once(G5_THEME_PATH . '/partials/teachers-list.php'); ?>
                    </div>
                </div>
                <!-- 서브페이지 [e] -->
