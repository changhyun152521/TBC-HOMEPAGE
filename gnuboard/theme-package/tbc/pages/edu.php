...
<main id="sh_container">
    <div id="sh_container_wrapper">
            ...
            <div id="shSubBnr">
                <div class="sub_nav">
                    <p class="crumb" data-aos="fade-up" data-aos-delay="300">
                        <a href="<?php echo G5_URL; ?>"><i data-feather="home"></i></a>더브코 소식 <i data-feather="chevron-right"></i>교육정보
                    </p>
                    <p class="tit" data-aos="fade-up" data-aos-delay="600">교육정보</p>
                </div>
        ...
        <div id="sh_content">
            <?php include_once(G5_THEME_PATH . '/partials/edu-list.php'); ?>
        </div>
    </div>
</main>
