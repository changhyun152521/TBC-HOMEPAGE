                ...
                <div id="shSubBnr">
                    <div class="sub_nav">
                        <p class="crumb" data-aos="fade-up" data-aos-delay="300">
                            <a href="<?php echo G5_URL; ?>"><i data-feather="home"></i></a>강사진 <i data-feather="chevron-right"></i>전체</p>
                        <p class="tit" data-aos="fade-up" data-aos-delay="600">전체 강사진</p>
                    </div>
                ...
                <div id="members1005">
                    <div class="inner">
                        ...
                        <ul class="instructor_list">
                            <li class="list01" id="teacher-yun" data-aos="fade-up">
                                <div class="img_box">
                                    <ul class="bg_txt">
                                        <li>과학</li>
                                        <li>개념</li>
                                    </ul>
                                    <img src="<?php echo G5_THEME_URL; ?>/img/sub/teacher1.png" alt="윤호진 강사">
                                </div>
                                <div class="left_txt">
                                    <div class="l_top">
                                        ...
                                        <div class="l_name_wrap">
                                            <span class="subject">과학 / 중등·고등</span>
                                            <b class="name">윤호진 강사</b>
                                        </div>
                                    </div>
                                    <ul class="l_btn_wrap">
                            ...
                            </li>                            <li class="list02" id="teacher-song" data-aos="fade-up">
                                <div class="img_box">
                                    <ul class="bg_txt">
                                        <li>수학</li>
                                        <li>입시</li>
                            ...
                            </li>                            <li class="list02" id="teacher-park" data-aos="fade-up">
                                <div class="img_box">
                                    <ul class="bg_txt">
                                        <li>영어</li>
                                        <li>독해</li>
