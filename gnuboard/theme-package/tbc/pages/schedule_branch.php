...
<main id="sh_container">
        ...
        <div id="sh_container_wrapper">
                ...
                <div id="shSubBnr">
                    <div class="sub_nav">
                        <p class="crumb" data-aos="fade-up" data-aos-delay="300">
                            <a href="<?php echo G5_URL; ?>"><i data-feather="home"></i></a>시간표 <i data-feather="chevron-right"></i>분원</p>
                        <p class="tit" data-aos="fade-up" data-aos-delay="600">분원 시간표</p>
                    </div>
            ...
            <div id="sh_content">
                <!-- 서브페이지 [s] -->
                <?php
                $tbc_schedule_title = '분원 시간표';
                $tbc_schedule_desc = '분원 강좌 전체를 확인하고, 관·학년·과목 필터로 원하는 강좌를 찾을 수 있습니다.';
                $tbc_schedule_group = 'branch';
