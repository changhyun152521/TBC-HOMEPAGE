                ...
                <div id="shGnb" data-aos="fade-in">
                    ...
                    <nav class="sh_nav">
                        <ul id="top_nav">
                            ...
                            <li class="list02">
                                <a href="<?php echo tbc_page_url('academies'); ?>">분원</a>
                                <ul>
                                    <li><a href="<?php echo tbc_page_url('academies'); ?>">전체 분원</a></li>
                                    <li><a href="<?php echo tbc_page_url('academies_main'); ?>">본원</a></li>
                    ...
                    <div id="allWrap" class="">
                        <div class="inner">
                            ...
                            <div class="cont sitemap">
                                <ul class="mn_img">
                                    <li data-panel-src="<?php echo htmlspecialchars(tbc_menu_panel_url('about'), ENT_QUOTES, 'UTF-8'); ?>"><a class="bmn" href="<?php echo tbc_page_url('greeting'); ?>">더브코</a></li>
                                    <li data-panel-src="<?php echo htmlspecialchars(tbc_menu_panel_url('academies'), ENT_QUOTES, 'UTF-8'); ?>"><a class="bmn" href="<?php echo tbc_page_url('academies'); ?>">분원</a></li>
                                    <li data-panel-src="<?php echo htmlspecialchars(tbc_menu_panel_url('teachers'), ENT_QUOTES, 'UTF-8'); ?>"><a class="bmn" href="<?php echo tbc_page_url('teachers'); ?>">강사진</a></li>
                                    <li data-panel-src="<?php echo htmlspecialchars(tbc_menu_panel_url('schedule'), ENT_QUOTES, 'UTF-8'); ?>"><a class="bmn" href="<?php echo tbc_page_url('schedule'); ?>">시간표</a></li>
                                    <li data-panel-src="<?php echo htmlspecialchars(tbc_menu_panel_url('news'), ENT_QUOTES, 'UTF-8'); ?>"><a class="bmn" href="<?php echo tbc_board_url('notice'); ?>">더브코 소식</a></li>
                                    <li data-panel-src="<?php echo htmlspecialchars(tbc_menu_panel_url('admission'), ENT_QUOTES, 'UTF-8'); ?>"><a class="bmn" href="<?php echo tbc_board_url('consult'); ?>">입학안내</a></li>
                                </ul>
                                <div class="right_img">
                                    <img src="<?php echo htmlspecialchars(tbc_menu_panel_url('default'), ENT_QUOTES, 'UTF-8'); ?>" alt="메뉴배경">
                ...
                <div id="navWrap">
                    <div class="inner">
                        <ul class="m_lnb">
                            ...
                            <li>
                                <button class="m_bmenu" type="button">분원</button>
                                <ul class="m_smenu">
                                    <li><a href="<?php echo tbc_page_url('academies'); ?>">전체 분원</a></li>
                                    <li><a href="<?php echo tbc_page_url('academies_main'); ?>">본원</a></li>
                                    <li><a href="<?php echo tbc_page_url('academies_branch'); ?>">분원 안내</a></li>
